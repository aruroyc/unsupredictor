...
class TrainClassifier():
    ...
    def train(self):
        ...
        dataset = self.handle_missing_values(dataset, self.target_header, -1)
        train_x, test_x, train_y, test_y = self.split_dataset(dataset, 0.7, self.headers[1:-1], self.target_header)
    ...
    def train_and_save(self):
        ...
        print(self.get_cluster_file_path())
        file_path = self.get_cluster_file_path()+self.target_header+'_'+str(round(acc,3))+".model"
